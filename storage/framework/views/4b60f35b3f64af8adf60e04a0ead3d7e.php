...
<div class="language-selector">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu language-dropdown" id="languageDropdownMenu" aria-labelledby="languageDropdown">
            <li>
                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('lang.switch', 'vi')); ?>">
                    <img src="https://twemoji.maxcdn.com/v/latest/svg/1f1fb-1f1f3.svg" width="16" height="16"
                        alt="VN">
                    &nbsp;<?php echo app('translator')->get('general.vietnamese'); ?>
                </a>
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('lang.switch', 'zh')); ?>">
                    <img src="https://twemoji.maxcdn.com/v/latest/svg/1f1e8-1f1f3.svg" width="16" height="16"
                        alt="CN">
                    &nbsp;<?php echo app('translator')->get('general.chinese'); ?>
                </a>
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('lang.switch', 'en')); ?>">
                    <img src="https://twemoji.maxcdn.com/v/latest/svg/1f1ec-1f1e7.svg" width="16" height="16"
                        alt="GB">
                    &nbsp;<?php echo app('translator')->get('general.english'); ?>
                </a>
...
<?php /**PATH C:\xampp\htdocs\educore\resources\views/components/auth-language-switcher.blade.php ENDPATH**/ ?>