...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dash-admin','data' => ['active' => 'attendances']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-0 text-primary fs-4">
                    <i class="bi bi-calendar-check mr-2"></i><?php echo e(__('views.attendance_overview')); ?>

                </h4>
                <p class="text-muted mb-0"><?php echo e(__('views.attendance_management_description')); ?></p>
            </div>
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('classrooms.index')); ?>" class="btn btn-outline-primary">
                    <i class="bi bi-mortarboard mr-2"></i><?php echo e(__('views.manage_classrooms')); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h5 class="mb-0 text-primary">
                            <i class="bi bi-funnel mr-2"></i><?php echo e(__('views.filter_by_month')); ?>
                ...
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title mb-0"><?php echo e(__('views.total_students')); ?></h6>
            ...
            <div class="col-md-3">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title mb-0"><?php echo e(__('views.active_classes')); ?></h6>
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title mb-0"><?php echo e(__('views.attendance_sessions')); ?></h6>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title mb-0"><?php echo e(__('views.average_rate')); ?></h6>
            ...
            <div class="col-md-6">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title mb-0"><?php echo e(__('views.present_count')); ?></h6>
            ...
            <div class="col-md-6">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title mb-0"><?php echo e(__('views.absent_count')); ?></h6>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-light">
                        <h5 class="mb-0 text-primary">
                            <i class="bi bi-trophy mr-2"></i><?php echo e(__('views.top_classes_attendance')); ?>
                    ...
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead class="table-light">
                                        <tr>
                                            <th><?php echo e(__('views.classroom')); ?></th>
                                            <th class="text-center"><?php echo e(__('views.total')); ?></th>
                                            <th class="text-center"><?php echo e(__('views.present')); ?></th>
                                            <th class="text-center"><?php echo e(__('views.rate')); ?></th>
                                            <th class="text-center"><?php echo e(__('views.actions')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group">
                                                        <a href="<?php echo e(route('classrooms.attendance', $classData['classroom'])); ?>"
                                                            class="btn btn-sm btn-outline-primary"
                                                            title="<?php echo e(__('views.attendance')); ?>">
                                                            <i class="bi bi-calendar-check"></i>
                                                        </a>
                                                        <a href="<?php echo e(route('classrooms.attendance-history', $classData['classroom'])); ?>"
                                                            class="btn btn-sm btn-outline-info"
                                                            title="<?php echo e(__('views.history')); ?>">
                                                            <i class="bi bi-calendar-week"></i>
                                                        </a>
                                                        <a href="<?php echo e(route('classrooms.show', $classData['classroom'])); ?>"
                                                            class="btn btn-sm btn-outline-secondary"
                                                            title="<?php echo e(__('views.details')); ?>">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                    </div>
                                                </td>
                        ...
                        <?php else: ?>
                            <div class="text-center py-4">
                                ...
                                <h5 class="text-muted"><?php echo e(__('views.no_attendance_data')); ?></h5>
                                <p class="text-muted">
                                    <?php echo e(__('views.no_attendance_data_description', ['month' => $this->getMonthName($selectedMonth), 'year' => $selectedYear])); ?>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-primary">
                            <i class="bi bi-clock-history mr-2"></i><?php echo e(__('views.recent_attendance')); ?>

                        </h5>
                        <a href="<?php echo e(route('attendances.history')); ?>"
                            class="btn btn-sm btn-outline-secondary float-end">
                            <i class="bi bi-calendar-week"></i> <?php echo e(__('views.attendance_history')); ?>
                    ...
                    <div class="card-body">
                        <!--[if BLOCK]><![endif]--><?php if($recentAttendances->count() > 0): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead class="table-light">
                                        <tr>
                                            <th><?php echo e(__('views.date')); ?></th>
                                            <th><?php echo e(__('views.classroom')); ?></th>
                                            <th><?php echo e(__('views.student')); ?></th>
                                            <th class="text-center"><?php echo e(__('views.status')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="fw-medium">
                                                        <?php echo e($attendance->classroom?->name ?? 'N/A'); ?></div>
                                                    <small
                                                        class="text-muted"><?php echo e($attendance->classroom?->level ?? 'N/A'); ?></small>
                                                </td>
                                                <td>
                                                    <div class="fw-medium">
                                                        <?php echo e($attendance->student?->user?->name ?? 'N/A'); ?>

                                                    </div>
                                                    <small
                                                        class="text-muted"><?php echo e($attendance->student?->user?->email ?? 'N/A'); ?></small>
                                                </td>
                                                <td class="text-center">
                                                    <!--[if BLOCK]><![endif]--><?php if($attendance->present): ?>
                                                        <span
                                                            class="badge bg-success"><?php echo e(__('views.present_status')); ?></span>
                                                    <?php else: ?>
                                                        <span
                                                            class="badge bg-danger"><?php echo e(__('views.absent_status')); ?></span>
                        ...
                        <?php else: ?>
                            <div class="text-center py-4">
                                <i class="bi bi-calendar-x fs-1 text-muted mb-3"></i>
                                <h5 class="text-muted"><?php echo e(__('views.no_attendance')); ?></h5>
                                <p class="text-muted"><?php echo e(__('views.no_attendance_description')); ?></p>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-light">
                        <h5 class="mb-0 text-primary">
                            <i class="bi bi-star mr-2"></i><?php echo e(__('views.top_excellent_students')); ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="text-center py-3">
                                ...
                                <p class="text-muted mb-0"><?php echo e(__('views.no_student_data')); ?></p>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="mb-0 text-primary">
                            <i class="bi bi-lightning mr-2"></i><?php echo e(__('views.quick_actions')); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href="<?php echo e(route('classrooms.index')); ?>" class="btn btn-primary w-100">
                                    <i class="bi bi-calendar-check mr-2"></i><?php echo e(__('views.attendance_by_class')); ?>

                                </a>
                            </div>
                            <div class="col-md-6 mb-3">
                                <a href="<?php echo e(route('classrooms.create')); ?>" class="btn btn-outline-primary w-100">
                                    <i class="bi bi-plus-circle mr-2"></i><?php echo e(__('views.create_new_class')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\educore\resources\views/admin/attendance/overview.blade.php ENDPATH**/ ?>