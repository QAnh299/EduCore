<div class="dropdown position-relative" x-data="{ open: false }">
    ...
    <i class="fas fa-user mr-2"></i><?php echo e(__('Thông tin tài khoản')); ?>
...
<div class="dropdown-divider"></div>
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button type="submit" class="dropdown-item text-danger">
                <i class="fas fa-sign-out-alt mr-2"></i><?php echo e(__('general.logout')); ?>
...
<?php /**PATH C:\xampp\htdocs\educore\resources\views/components/logout.blade.php ENDPATH**/ ?>