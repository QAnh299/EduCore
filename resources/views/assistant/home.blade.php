<x-layouts.dash-assistant active="home">
    @include('components.language')
    <div class="container py-4">
        <div class="row g-4 gy-5">
            <!-- Lớp học của tôi -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.my-class.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Lịch giảng dạy -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.schedules.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Điểm danh -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.attendance.overview') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Bài học -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.lessons.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Bài tập -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.assignments.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Kiểm tra & Quiz -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.quizzes.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Chấm bài -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.grade-entry-assistant.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Báo cáo lớp học -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.reports.index') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
            ...
            <!-- Thông báo -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.notifications.index') }}" class="text-decoration-none text-dark">
            ...
            <!-- Báo cáo đánh giá SV -->
            <div class="col-6 col-md-3 text-center">
                <a href="{{ route('assistant.evaluations.report') }}" class="text-decoration-none text-dark">
                    <div class="mb-2">
