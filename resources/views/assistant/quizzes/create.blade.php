<x-layouts.dash-assistant active="quizzes">
    @include('components.language')
    <div class="container-fluid">
        <!-- Header -->
        <div class="mb-4">
            <a href="{{ route('assistant.quizzes.index') }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('assistant.ai.quiz-generator') }}" class="btn btn-primary">
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('assistant.ai.question-bank-generator') }}" class="btn btn-success">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-body text-end">
                            <a href="{{ route('assistant.quizzes.index') }}" class="btn btn-secondary mr-2">
                        ...
                        <div class="modal-body">
                            ...
                            @else
                                <div class="text-center text-muted py-5">
                                    ...
                                    <a href="{{ route('assistant.ai.question-bank-generator') }}"
