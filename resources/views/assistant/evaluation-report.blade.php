<x-layouts.dash-assistant active="evaluations-report">
    ...
    <div class="container py-4">
        ...
        <div class="alert alert-info mb-4">
            ...
            <ul class="mb-1">
                <li><b>{{ __('general.assistant_rating_avg') }}</b></li>
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        <div class="fw-bold text-success fs-3">{{ number_format($avgassistant, 1) }}</div>
                        <div class="text-muted">{{ __('general.assistant_rating_average') }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>{{ __('general.assistant_score') }}</th>
                        ...
                        <tbody>
                            @forelse ($evaluations as $eva)
                                <tr>
                                    ...
                                    <td>{{ number_format($eva->getassistantAverageRating(), 1) }}</td>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <strong>{{ __('general.group_1_assistant_evaluation') }}</strong>
                                <ul class="mb-2">
                                    @foreach ($selectedEvaluation->assistant_ratings ?? [] as $k => $v)
                                        @php
                                            $question = $questions
