<x-layouts.dash-assistant active="assignments">
    ...
    <div class="container py-4">
        <!-- Header -->
        <div class="mb-4">
            <a href="{{ route('assistant.assignments.index') }}" class="text-decoration-none text-secondary">
            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent="createAssignment">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('assistant.assignments.index') }}" class="btn btn-outline-secondary">{{ __('general.cancel') }}</a>
