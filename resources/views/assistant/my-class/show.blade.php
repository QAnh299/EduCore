<x-layouts.dash-assistant active="my-class">
        ...
        <div class="row mb-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('assistant.my-class.index') }}" class="text-decoration-none">
            ...
            <div class="col-md-4 text-end">
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('assistant.attendance.take', $classroom) }}" class="btn btn-primary btn-sm">
                        <i class="bi bi-calendar-check mr-1"></i>
                        {{ __('general.new_attendance') }}
                    </a>
                    <a href="{{ route('assistant.lessons.create', ['classroom_id' => $classroom->id]) }}"
                        class="btn btn-outline-primary btn-sm">
                        <i class="bi bi-plus-circle mr-1"></i>
                        {{ __('general.add_lesson') }}
                    </a>
                    <a href="{{ route('assistant.assignments.create', ['classroom_id' => $classroom->id]) }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('assistant.lessons.show', $lesson->id) }}"
                                                    class="btn btn-outline-warning">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('assistant.lessons.edit', $lesson->id) }}"
                            ...
                            <tbody>
                                @forelse($attendanceSessions as $session)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('assistant.attendance.take', $classroom) }}?date={{ $session['date']->format('Y-m-d') }}" class="btn btn-outline-primary btn-sm">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
