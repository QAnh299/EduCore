<x-layouts.dash-assistant active="attendances">
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('assistant.my-class.index') }}" class="btn btn-outline-primary">
            ...
            <div class="col-lg-8">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group">
                                                        <a href="{{ route('assistant.attendance.take', $classData['classroom']) }}"
                                                            class="btn btn-sm btn-outline-primary" title="{{ __('general.new_attendance') }}">
                                                            <i class="bi bi-calendar-check"></i>
                                                        </a>
                                                        <a href="{{ route('assistant.attendance.classroom-history', $classData['classroom']) }}"
                                                            class="btn btn-sm btn-outline-info" title="{{ __('general.attendance_history') }}">
                                                            <i class="bi bi-calendar-week"></i>
                                                        </a>
                                                        <a href="{{ route('assistant.my-class.show', $classData['classroom']) }}"
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('assistant.attendance.history') }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href="{{ route('assistant.my-class.index') }}" class="btn btn-primary w-100">
