<x-layouts.dash-teacher active="grade-entry" title="Chi tiết điểm">

<div class="container mt-4">

    <!-- Nút quay lại -->
    <div class="mb-3 d-flex justify-content-between">
        <a href="{{ route('teacher.grade-entry-teacher.index') }}"
           class="btn btn-outline-secondary d-inline-flex align-items-center">
            ← Quay lại
        </a>

        <!-- Nút thêm điểm -->
        <a href="{{ route('teacher.grade-entry-teacher.create', $student->id) }}"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{ route('teacher.grade-entry-teacher.edit', $grade->id) }}"
