                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select wire:model="level"
                                            ...
                                            <option value="Lớp 6">{{ __('general.basic1') }}</option>
                                            <option value="Lớp 7">{{ __('general.basic2') }}</option>
                                            <option value="Lớp 8">{{ __('general.intermediate1') }}</option>
                                            <option value="Lớp 9">{{ __('general.intermediate2') }}</option>
                                            <!--
                                            <option value="Lớp 6">{{ __('general.advanced1') }}</option>
                                            <option value="Lớp 6">{{ __('general.advanced2') }}</option>
-->
                                        </select>
                                        @error('level')
                                            <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div
                    ...
                    <img src="/smash-logo.png" alt="{{ __('general.edit_student') }}" class="mb-3"
