...
namespace App\Livewire\Assistant\Notifications;
...
class Index extends Component
{
    ...
    public function store()
    {
        ...
        if (empty($this->class_id)) {
            ...
            // Kiểm tra xem assistant có quyền gửi thông báo cho lớp này không
    ...
    public function render()
    {
        ...
        return view('assistant.notifications.index', [
