...
namespace App\Livewire\Assistant\Grading;
...
class GradeAssignment extends Component
{
    ...
    public function saveGrade($submissionId)
    {
        ...
        if ($score !== null && $score !== '') {
            ...
            if (! is_numeric($score) || ! is_finite($score)) {
                return redirect()->route('assistant.grading.grade-assignment', $this->assignmentId)
    ...
    {
        return view('assistant.grading.grade-assignment', [
