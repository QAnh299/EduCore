...
namespace App\Livewire\Assistant\Reports;
...
class Index extends Component
{
    ...
    {
        $assistant = Auth::user();
        $this->classrooms = $assistant->teachingClassrooms()->get();
    ...
    {
        $assistant = Auth::user();
        $classIds = $assistant->teachingClassrooms()->pluck('classrooms.id');
 ...
 $submitRate = $assignments->count() > 0 
    ...
    : 0;
       //? round($submissions->count() / $assignments->count() * 100): 0;
        ...
        return view('assistant.reports.index', [
