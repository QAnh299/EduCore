...
class Create extends Component
{
    ...
    public function testSave()
    {
        ...
        // Lấy classroom đầu tiên của assistant
        $classroom = Classroom::whereHas('assistants', function ($query) {
    ...
    public function save()
    {
        try {
            ...
            return redirect()->route('assistant.quizzes.show', $quiz);
        } catch (\Exception $e) {
    ...
    public function render()
    {
        ...
        Log::info('Classrooms found for assistant', [
        ...
        return view('assistant.quizzes.create', [
